...
#pragma mark - Platform implementation
   ...
   * @param type EMsgBoxType, EMsgBoxIcon describing the button options available \see EMsgBoxType & EMsgBoxIcon
  ...
  virtual EMsgBoxResult ShowMessageBox(const char* str, const char* title, EMsgBoxType type, EMsgBoxIcon icon, IMsgBoxCompletionHandlerFunc completionHandler = nullptr) = 0;
...
public:
  ...
  /** Vasan Addad -> Attach any conrtol as the lowest IControl in the control stack to fill the background with a solid color
